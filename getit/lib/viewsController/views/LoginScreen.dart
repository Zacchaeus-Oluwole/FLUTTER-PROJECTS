...
import 'package:getit/viewsController/views/HomeScreen.dart';
import 'package:getit/viewsController/views/animation.dart';
import 'package:getit/viewsController/views/SignupScreen.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> loginUser() async {
    final String apiUrl = 'http://127.0.0.1:8007/api/auth/login';
